/*******************************************************************************
*
*	タイトル：	8分木空間分割シーンクラス	[ demo_CollisionSplit1.h ]
*
*	作成者：	古本 泰隆
*
*******************************************************************************/
...
class Demo_CollisionSplit1 : public Scene
{
	void Init() override
	{
		...
		Collision3DManager::ResetSpace(1, Collision3DManager::GetMin(), Collision3DManager::GetSize());
